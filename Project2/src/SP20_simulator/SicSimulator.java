...
public class SicSimulator {
	...
	InstLuncher instLuncher; //명령어 실행기
	Vector<String> instList = new Vector<>(); //GUI Instructions 저장
	Vector<String> logList = new Vector<>(); // GUI Log 저장
